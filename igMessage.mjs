...
async function main() {
  try {
    ...
    await exec('google-chrome --new-window https://www.instagram.com/trashcant61901123/');
    ...
    log('Pressing Tab 15 times to reach message button...');
    await pressTabRandomly(15);
    ...
    // Typing a message to send
    log ('Typing a message for the user...');
    await typeText ('Hi this message is a test.');
    ...
    return JSON.stringify({
      ...
      data: {
        visitedUrl: 'https://www.instagram.com/trashcant61901123/',
